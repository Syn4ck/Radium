...
#define DCEL_CHECK_CONSISTENCY     ( 1 << 13 )
...
#define DCEL_CHECK_HALFEDGE_DEFAULT  DCEL_CHECK_INDEX | DCEL_CHECK_VERTEX_PTR | DCEL_CHECK_HALFEDGE_NEXT | DCEL_CHECK_HALFEDGE_PREV | DCEL_CHECK_HALFEDGE_TWIN | DCEL_CHECK_FULLEDGE_PTR
