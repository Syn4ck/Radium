...
bool fulledgeSplit( Dcel& dcel, const Index& fulledge_id ) {
    FullEdge_ptr ptr;
    if( !dcel.m_fulledge.access( fulledge_id, ptr ) ) return false;
    CORE_ASSERT( isValid( ptr ), "FullEdge is corrupted." );
    ...
    v = new Vertex( ( 0.5 * ( ptr->V( 0 )->P() + ptr->V( 1 )->P() ) ),
    ...
    he[0][1] = ptr->HE( 0 );
    he[0][2] = new HalfEdge( v );
    he[1][0] = ptr->HE( 1 )->Next();
    he[1][1] = new HalfEdge( ptr->HE( 1 )->Prev()->V() );
    he[1][2] = ptr->HE( 1 );
    he[2][0] = ptr->HE( 1 )->Prev();
    he[2][1] = new HalfEdge( ptr->HE( 1 )->V() );
    he[2][2] = new HalfEdge( v );
    he[3][0] = ptr->HE( 0 )->Next();
    he[3][1] = new HalfEdge( ptr->HE( 0 )->Prev()->V() );
    he[3][2] = new HalfEdge( v );

    // Prepare the fulledges
    fe[0] = ptr;
    fe[1] = new FullEdge( he[1][1] );
    fe[2] = new FullEdge( he[2][1] );
    fe[3] = new FullEdge( he[3][1] );
