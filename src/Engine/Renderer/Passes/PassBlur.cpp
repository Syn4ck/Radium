...
namespace Ra {
    namespace Engine {
        ...
        void PassBlur::resizePass()
        {
            ...
            m_internalTextures[TEX_BLUR_PING]->initGL(GL_RGBA32F, m_width, m_height, GL_RGBA, GL_FLOAT, nullptr);
            m_internalTextures[TEX_BLUR_PONG]->initGL(GL_RGBA32F, m_width, m_height, GL_RGBA, GL_FLOAT, nullptr);
            ...
            m_fbo[FBO_MAIN]->attachTexture( GL_COLOR_ATTACHMENT2, m_internalTextures[TEX_BLUR_PING].get() );
            m_fbo[FBO_MAIN]->attachTexture( GL_COLOR_ATTACHMENT3, m_internalTextures[TEX_BLUR_PONG].get() );
