...
namespace QRadium
{
    ...
    public:
        ...
        const Ra::Engine::Renderer* getRenderer() const {  return m_viewer->getRenderer(); }
        const Ra::Gui::Viewer* getViewer() const { return m_viewer; }
        Ra::Gui::Viewer* getViewer() { return m_viewer; }
        ...
        void fitCameraToScene( const Ra::Core::Aabb& sceneAabb );
    ...
    public slots:
        ...
        void setGizmoEditable(Ra::Engine::EditableInterface* edit) { m_viewer->getGizmoManager()->setEditable(edit); }
