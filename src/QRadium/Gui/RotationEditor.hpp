...
namespace QRadium
{
    ...
    public:
        ...
        void setValue( const Ra::Core::Quaternion& quat )
        {
            Ra::Core::Matrix3 m = quat.toRotationMatrix();
            Ra::Core::Vector3 ypr = m.eulerAngles( 2, 1, 0 ); //yaw pitch roll.
    ...
    signals:
        ...
        void valueChanged( const Ra::Core::Quaternion& newValue, uint id );
    ...
    private slots:
        ...
        {
            Ra::Core::Vector3 ypr( Ra::Core::Math::toRadians( Scalar( m_z->value() ) ),
                                   Ra::Core::Math::toRadians( Scalar( m_y->value() ) ),
                                   Ra::Core::Math::toRadians( Scalar( m_x->value() ) ) );
            resetRel();
            updateAbsSlide( ypr );
            m_startRelTransformYpr = ypr;
            Ra::Core::Quaternion quat = Ra::Core::AngleAxis( ypr[0], Ra::Core::Vector3::UnitZ() )
                    * Ra::Core::AngleAxis( ypr[1], Ra::Core::Vector3::UnitY() )
                    * Ra::Core::AngleAxis( ypr[2], Ra::Core::Vector3::UnitX() );
        ...
        void onValueChangedAbsSlide()
        {
            ...
            const Ra::Core::Vector3 ypr = Ra::Core::Vector3( Ra::Core::Math::toRadians( z ),
                                                             Ra::Core::Math::toRadians( y ),
                                                             Ra::Core::Math::toRadians( x ) );
            m_relativeAxis = -1;
            resetRel();
            updateAbsSpin( ypr );
            m_startRelTransformYpr = ypr;
    ...
    private:
        ...
        void valueChangedSpinRel( uint axis )
        {
            if ( m_relativeAxis != axis )
            {
                ...
                m_relativeAxis = axis;
                resetRel();
                m_startRelTransformYpr = Ra::Core::Vector3( Ra::Core::Math::toRadians( z ),
                                                            Ra::Core::Math::toRadians( y ),
                                                            Ra::Core::Math::toRadians( x ) );
            }


            Ra::Core::Quaternion quat = Ra::Core::AngleAxis( m_startRelTransformYpr[0], Ra::Core::Vector3::UnitZ() )
                    * Ra::Core::AngleAxis( m_startRelTransformYpr[1], Ra::Core::Vector3::UnitY() )
                    * Ra::Core::AngleAxis( m_startRelTransformYpr[2], Ra::Core::Vector3::UnitX() );

            Ra::Core::Quaternion rotX( Ra::Core::AngleAxis( Ra::Core::Math::toRadians( m_relSliders[axis]->value() ),
                                                            Ra::Core::Vector3::Unit( axis ) ) );

            quat = quat * rotX;

            const Ra::Core::Vector3 newYpr = quat.toRotationMatrix().eulerAngles( 2, 1, 0 );
        ...
        void valueChangedSlideRel( uint axis )
        {
            ...
            Ra::Core::Quaternion rotX( Ra::Core::AngleAxis( Ra::Core::Math::toRadians( Scalar( m_relSliders[axis]->value() ) ),
                                                        Ra::Core::Vector3::Unit( axis ) ) );
        ...
        void updateAbsSpin( const Ra::Core::Vector3& ypr )
        {
            ...
            m_x->setValue( Ra::Core::Math::toDegrees( ypr.z() ) ); // roll
            m_y->setValue( Ra::Core::Math::toDegrees( ypr.y() ) ); // pitch
            m_z->setValue( Ra::Core::Math::toDegrees( ypr.x() ) ); // yaw
        ...
        void updateAbsSlide( const Ra::Core::Vector3& ypr )
        {
            m_slider_x->blockSignals( true );
            m_slider_y->blockSignals( true );
            m_slider_z->blockSignals( true );

            m_slider_x->setValue( int( Ra::Core::Math::toDegrees( ypr.z() ) ) ); // roll
            m_slider_y->setValue( int( Ra::Core::Math::toDegrees( ypr.y() ) ) ); // pitch
            m_slider_z->setValue( int( Ra::Core::Math::toDegrees( ypr.x() ) ) ); // yaw
    ...
    private:
        ...
        Ra::Core::Vector3 m_startRelTransformYpr;
        int m_relativeAxis;
    };
}
